...
export default function UserPage() {
  ...
  const openEditModal = (type: "email" | "celular", currentValue: string) => {
    setEditType(type);
    setEditValue(
      currentValue !== "Email não informado" &&
        currentValue !== "Celular não informado"
        ? currentValue
        : "",
    );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (error.code === "auth/requires-recent-login") {
        mensagemErro =
          "Por segurança, você precisa SAIR do app e fazer login novamente para alterar o e-mail.";
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity
          onPress={() => router.push("/(tabs)/userPage")}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <TextInput
              ...
              keyboardType={
                editType === "email" ? "email-address" : "phone-pad"
              }
              autoCapitalize="none"
              placeholder={
                editType === "email"
