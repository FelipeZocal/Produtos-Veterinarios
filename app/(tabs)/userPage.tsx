...
// Importando Model, Service e Contexto do Carrinho
    ...
    switch (option) {
      case "profile":
        if (!auth.currentUser) {
          if (Platform.OS === "web") {
            window.alert(
              "É necessário realizar o login para acessar o perfil.",
            );
          } else {
            Alert.alert(
              "Acesso Restrito",
    ...
    if (Platform.OS === "web") {
      ...
      if (confirmacao) {
        try {
          ...
          window.alert("Erro ao encerrar sessão.");
        }
      }
    } else {
  ...
  const handleSalvar = async () => {
    ...
    try {
      if (editingId) {
        ...
        // Fluxo de Adição de Novo Produto
        ...
        // 🟢 DISPARO DA NOTIFICAÇÃO LOCAL AQUI 🟢
        // Assim que o produto for salvo no Firebase/JSONBin, a notificação aparece
        await Notifications.scheduleNotificationAsync({
          content: {
            title: "🔥 Promoção na AgroVet!",
            body: `O produto ${medNome} acabou de ser adicionado${medPreco ? ` por apenas R$ ${medPreco}` : ''}. Venha conferir!`,
            sound: true,
          },
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Text style={styles.bannerBtnText}>Acessar Carrinho</Text>
        </TouchableOpacity>
        <TouchableOpacity
          ...
          <Pressable style={styles.modalOverlay} onPress={toggleMenu}>
            <View style={styles.menuBar}>
              ...
              >
                ...
                <Text style={[styles.menuBarText, { color: "#C62828" }]}>
                  Sair
                </Text>
              </TouchableOpacity>
            </View>
      ...
      >
        ...
        <View style={styles.bannerCard}>
          <Text style={styles.bannerTitle}>Melhor Produtos Veterinários</Text>
          <Text style={styles.bannerSubtitle}>
            Melhores preços do mercado!.
          </Text>
        </View>

        {/* Header da Seção de Grid */}
        ...
        <View style={styles.grid}>
          ...
          <TouchableOpacity style={styles.gridItemAdd} onPress={openAddModal}>
            ...
            <Text style={[styles.gridText, { color: "#2D5A27" }]}>
              Adicionar
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.alertSection}>
          ...
          <Text style={styles.alertText}>• Vacinar Aftosa.</Text>
        </View>
      </ScrollView>

      {/* Modal do Form do CRUD */}
      <Modal
        visible={modalCrudVisible}
        transparent={true}
        animationType="slide"
        onRequestClose={closeCrudModal}
      >
...
const styles = StyleSheet.create({
  ...
  // Estilos Adicionados do Botão do Carrinho e Navegação de Notificações
  notificationNavBtn: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "#FFF",
  ...
  btnAddCartText: { color: "#2D5A27", fontSize: 13, fontWeight: "bold" },
});
